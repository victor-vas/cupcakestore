    ...
    <div className="max-w-[1280px] mx-auto px-5 py-5">
      ...
      <div className="mb-20 mt-20">
        <div className="flex items-center space-x-5 mb-10">
          ...
          <span className="font-medium text-xl">Descrição do Produto</span>
        </div>
        {product && (
            ...
            <div className="fles flex-col justify-center">
              <div className="grid grid-cols-3 gap-5 mb-5">
                <div>
                  ...
                  <p className="text-sm text-purple-500">{product.batter}</p>
                </div>
                <div>
                  <h3 className="font-medium">Recheio</h3>
                  <p className="text-sm text-purple-500">{product.filling}</p>
                </div>
                <div>
                  <h3 className="font-medium">Cobertura</h3>
                  <p className="text-sm text-purple-500">{product.top}</p>
                </div>
              </div>
            </div>
      ...
      <div className="mt-20 mb-20">
        <div className="flex items-center space-x-5 mb-10">
          ...
          <span className="font-medium text-xl">
            Seção de Comentários e Opiniões
          </span>
        </div>
        <div className="grid grid-cols-2">
          <div>
            {allReview.map((review, index) => (
              <div key={review.id} className="mb-5">
                <h1 className="mb-2 font-medium">Comentários: {index + 1}</h1>
